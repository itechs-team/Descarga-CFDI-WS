...
namespace sw.descargamasiva
{
    public abstract class SoapRequestBase
    {
        ...
        public Tuple<string, int, int, string> Send(string autorization = null)
        {
            try
            {
                if (xml == null)
        ...
        public abstract Tuple<string, int, int, string> GetResult(XmlDocument xmlDoc);
